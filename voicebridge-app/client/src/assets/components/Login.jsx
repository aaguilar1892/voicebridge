           ...
           <div class = "w-150 h-102 p-6 shadow-2xl bg-white rounded-xl border-4 border-gray-500 shadow-yellow-600">
               <form onSubmit = { handleSubmit }>
                   ...
                   <div class = "mt-3">
                       ...
                       <input type = "password" id = "password" class = "border w-full text-base px-2 py-2 focus:outline-none focus:ring-0 focus:border-gray-600 rounded shadow-xl" placeholder = "Enter Password"
